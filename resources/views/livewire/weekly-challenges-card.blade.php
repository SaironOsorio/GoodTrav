<div class="bg-[#ff5170] dark:bg-zinc-900 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6 shadow-sm hover:shadow-md transition-shadow">
    ...
    <div class="mb-4 flex items-start justify-between">
        <div>
            ...
            <p class="text-sm text-black dark:text-gray-400 rounded-lg montserrat-regular">Completa tus actividades y gana puntos</p>
        </div>
    ...
    @if($totalCount > 0)
        <a href="{{ route('study') }}" wire:navigate
            class="w-full block px-6 py-3 bg-[#5170ff] hover:bg-[#4060ef] text-white text-sm font-semibold rounded-lg transition-all duration-300 text-center inline-flex items-center justify-center gap-2">
